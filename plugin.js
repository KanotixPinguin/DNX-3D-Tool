...
function addBtn(){
    ...
    b.style.setProperty("z-index","1000601","important");
    b.style.setProperty("cursor","grab","important");

    let pos={left:"20px",top:"80px"};

    try{

      let p=JSON.parse(localStorage.getItem("dnx3d_btn_pos"));

      if(p) pos=p;

    }catch(e){}

    b.style.setProperty("left",pos.left,"important");
    b.style.setProperty("top",pos.top,"important");

    if(!window.__dnxBtnDrag){

      window.__dnxBtnDrag=true;
      ...
      b.addEventListener("mousedown",function(e){
        ...
        ox=e.clientX-b.offsetLeft;
        oy=e.clientY-b.offsetTop;
...
(function(){
  ...
  function applyDNX(){
    ...
    b.style.setProperty(
      "background",
      "linear-gradient(90deg,#001018,#002c3d)",
      "important"
    );
